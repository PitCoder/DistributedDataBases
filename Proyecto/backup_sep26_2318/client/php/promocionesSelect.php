...
//STARTS PROGRAM
	...
	$sql = "SELECT * FROM Modelo WHERE descuento>0";
	...
	for ($x = 0; $x < count($encode); $x++){
		...
		if($Model['existencias']>0){
			...
			$money = "<span class='price'> $  $precioMueble MXN   </span><br> <b> Descuento del: $aDescontar %  </b><br><b class='s1 discount'>$ $descontado MXN</b><br><br>";
