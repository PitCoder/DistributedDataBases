<?php 
	...
	class Vertical extends Fragmento{
		...
		function getCreate($sitio){
		    $sql = "CREATE TABLE V".$sitio.$this->origen.getDate()['yday'].$this->getId()." (";
		...
		function getInsert($sitio){
		    ...
		    $sql = "INSERT INTO V".$sitio.$this->origen.getDate()['yday'].$this->getId()." VALUES ";
